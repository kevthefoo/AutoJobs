import { Project, Draft, Idea, TechTemplate, ProjectTech, WizardData, DEFAULT_WIZARD_DATA } from "./types";
import { v4 as uuidv4 } from "uuid";

const PROJECTS_KEY = "app-planner-projects";
const DRAFTS_KEY = "app-planner-drafts";
const IDEAS_KEY = "app-planner-ideas";
const TEMPLATES_KEY = "app-planner-templates";
...
export function createTechTemplate(name: string, description: string, tech: ProjectTech): TechTemplate {
