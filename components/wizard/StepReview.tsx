            ...
            <section className="border rounded-lg p-4 space-y-2">
                ...
                <div className="text-sm space-y-1">
                    ...
                    <p>
                        ...
                        {niceToHave.length > 0
                            ? niceToHave.map((f) => f.name).join(", ")
                            : "—"}
                    </p>
                    <p>
                        <span className="text-muted-foreground">Personas:</span>{" "}
                        {data.features.personas.length > 0
                            ? data.features.personas
                                  .map((p) => p.name)
                                  .join(", ")
                            : "—"}
                    </p>
                    <p>
                        ...
                        {data.features.userFlows.length > 0
                            ? data.features.userFlows
                                  .map((f) => f.title)
                                  .join(", ")
                            : "—"}
                    </p>
            ...
            <section className="border rounded-lg p-4 space-y-2">
                ...
                <div className="text-sm space-y-1">
                    <p>
                        ...
                        {displayTech(data.tech.language)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Framework:
                        </span>{" "}
                        {displayTech(data.tech.framework)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">UI/UX:</span>{" "}
                        {displayTech(data.tech.uiux)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">Database:</span>{" "}
                        {displayTech(data.tech.database)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">Storage:</span>{" "}
                        {displayTech(data.tech.storage)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">CI/CD:</span>{" "}
                        {displayTech(data.tech.cicd)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">Payment:</span>{" "}
                        {displayTech(data.tech.payment)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Integrations:
                        </span>{" "}
                        {displayTech(data.tech.integrations)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Performance:
                        </span>{" "}
                        {displayTech(data.tech.performanceRequirements)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Auth Needs:
                        </span>{" "}
                        {displayTech(data.tech.authNeeds)}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Auth Method:
                        </span>{" "}
                        {displayTech(data.tech.authMethod)}
                    </p>
                </div>
            </section>
            ...
            <section className="border rounded-lg p-4 space-y-2">
                ...
                <div className="text-sm space-y-1">
                    ...
                    <p>
                        ...
                        {data.design.responsiveRequirements || "—"}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            Accessibility:
                        </span>{" "}
                        {data.design.accessibilityNeeds || "—"}
                    </p>
                    <p>
                        <span className="text-muted-foreground">
                            References:
                        </span>{" "}
                        {data.design.referenceApps || "—"}
                    </p>
                </div>
            </section>
